...
public class EncomendaController {
    ...
    public List<EncomendasDTO> listarEncomendasDoOperador(@RequestHeader("Authorization") String auth) {
    ...
    public List<EncomendasDTO> listarEncomendasNaoAtribuidasDoOperador(@RequestHeader("Authorization") String auth) {
        String token = auth.replace("Bearer ", "");
